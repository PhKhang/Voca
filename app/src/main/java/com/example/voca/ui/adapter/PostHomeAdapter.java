...
public class PostHomeAdapter extends BaseAdapter {
    private Context context;
    private List<PostDTO> posts;

    public PostHomeAdapter(Context context, List<PostDTO> posts) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (post.getSong_id() != null) {
            ...
            holder.thumbnail.setImageResource(R.drawable.ic_profile_2_24dp); // Ảnh mặc định
